...
export const COMPANIES = [
  {
    ...
    name: "Pathao",
    slug: "pathao",
    logo: "https://api.dicebear.com/7.x/initials/svg?seed=Pathao&backgroundColor=e11d48&textColor=ffffff",
    ...
    founded: "2015",
    description: "Moving Bangladesh forward. Pathao is the leading ride-sharing, food delivery, and e-commerce logistics platform in Bangladesh.",
    fullDescription: "Pathao is the leading digital platform in Bangladesh, providing ride-sharing, food delivery, and logistics services. We're on a mission to empower people and solve the most pressing problems of our society through technology.",
    socials: { twitter: "@pathao", linkedin: "pathao" },
    benefits: ["Hybrid work", "Health insurance", "Free meals", "Performance bonus"],
  },
  {
    id: "2",
    name: "bKash",
    slug: "bkash",
    logo: "https://api.dicebear.com/7.x/initials/svg?seed=bKash&backgroundColor=d81b60&textColor=ffffff",
    industry: "Fintech",
    size: "1001–5000",
    location: "Dhaka, Bangladesh",
    color: "#d81b60",
    ...
    founded: "2011",
    description: "The largest Mobile Financial Service provider in Bangladesh, ensuring fast, affordable and secure financial transactions.",
    fullDescription: "bKash is a mobile financial service in Bangladesh operating under the authority of Bangladesh Bank. It provides a platform for people to make payments, transfer money, and more through their mobile phones.",
    socials: { twitter: "@bkash", linkedin: "bkash" },
    benefits: ["Competitive salary", "PF & Gratuity", "Yearly increments", "Medical benefits"],
  },
  {
    id: "3",
    name: "ShopUp",
    slug: "shopup",
    logo: "https://api.dicebear.com/7.x/initials/svg?seed=ShopUp&backgroundColor=4f46e5&textColor=ffffff",
    ...
    founded: "2017",
    description: "Building the digital infrastructure for small businesses in Bangladesh. ShopUp is the country's largest B2B commerce platform.",
    fullDescription: "ShopUp is Bangladesh's leading full-stack B2B commerce platform. We provide small businesses with access to digital credit, B2B sourcing, logistics, and business management tools.",
    socials: { twitter: "@shopup", linkedin: "shopup" },
    benefits: ["Equity options", "Learning budget", "Flexible PTO", "Wellness programs"],
  },
  {
    id: "4",
    name: "Nagad",
    slug: "nagad",
    logo: "https://api.dicebear.com/7.x/initials/svg?seed=Nagad&backgroundColor=f97316&textColor=ffffff",
    industry: "Fintech",
    size: "501–1000",
    location: "Dhaka, Bangladesh",
    color: "#f97316",
    ...
    founded: "2019",
    description: "The fastest-growing digital financial service in Bangladesh, committed to financial inclusion and digitalization.",
    fullDescription: "Nagad is a digital financial service of the Bangladesh Post Office. It's a fast-growing MFS that aims to bring millions of unbanked people into the formal financial system.",
    socials: { twitter: "@nagad", linkedin: "nagad" },
    benefits: ["Fast career growth", "Health insurance", "Transport allowance", "Training sessions"],
  },
  {
    id: "5",
    name: "Chaldal",
    slug: "chaldal",
    logo: "https://api.dicebear.com/7.x/initials/svg?seed=Chaldal&backgroundColor=10b981&textColor=ffffff",
    industry: "E-commerce",
    size: "501–1000",
    location: "Dhaka, Bangladesh",
    color: "#10b981",
    ...
    founded: "2013",
    description: "The largest online grocery store in Bangladesh. We believe in saving time and energy for our customers.",
    fullDescription: "Chaldal is an online grocery and food delivery platform. We utilize advanced logistics and inventory management to deliver groceries to customers' doorsteps in record time.",
    socials: { twitter: "@chaldal", linkedin: "chaldal" },
    benefits: ["Employee discounts", "Subsidized meals", "Work-life balance", "Community events"],
  },
];

export const MANAGE_COMPANIES = [
  { id: "c1", name: "Pathao", industry: "Logistics", location: "Dhaka", status: "verified", created: "Jan 15, 2025", activeJobs: 4 },
  { id: "c2", name: "TechStudio", industry: "Design Agency", location: "Sylhet", status: "pending", created: "Mar 10, 2025", activeJobs: 0 },
];
...
export const TESTIMONIALS = [
  {
    ...
    company: "Hired at Pathao",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=TariqulIslam&backgroundColor=b6e3f4",
    rating: 5,
    text: "Tech_Jobs made my job search feel effortless. The quality of listings is exceptional — every role felt hand-picked. I landed my dream offer at Pathao within 3 weeks!",
  },
  {
    id: "2",
    name: "Sadia Rahman",
    role: "ML Engineer",
    company: "Hired at Nagad",
  ...
  },
  {
    ...
    name: "Nadia Hossain",
    role: "UI/UX Designer",
    company: "Hired at Chaldal",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=NadiaHossain&backgroundColor=ffdfbf",
    rating: 4,
    text: "The platform's design itself is a testament to their focus on quality. I applied to several top design roles and was hired at Chaldal seamlessly.",
  },
  {
    id: "5",
    name: "Rakib Hasan",
    role: "Backend Engineer",
    company: "Hired at bKash",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=RakibHasan&backgroundColor=c0aede",
    rating: 5,
    text: "The best part about Tech_Jobs is the transparency. I knew the salary range and tech stack before even applying. Got an amazing offer from bKash!",
  },
  {
    id: "6",
...
export const STATS = [
  { label: "Active Jobs", value: "450+", suffix: "" },
  { label: "Companies Hiring", value: "120+", suffix: "" },
  { label: "Successful Hires", value: "1,200+", suffix: "" },
  { label: "Avg. Time to Hire", value: "24", suffix: " days" },
];
